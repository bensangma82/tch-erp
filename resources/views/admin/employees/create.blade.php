        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Create a hospital employee record. ERP login access is managed separately under User Management.
                </p>
            </div>
            ...
            >
                ...
                <div class="rounded-xl bg-white p-6 shadow-sm">
                    ...
                    <div class="mb-5">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Enter the employee's core identity and employment details.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Sr." @selected(old('title') === 'Sr.')>Sr.</option>
                                <option value="Br." @selected(old('title') === 'Br.')>Br.</option>
                                <option value="Rev." @selected(old('title') === 'Rev.')>Rev.</option>
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('professional_registration_no') }}"
                                maxlength="100"
                                placeholder="Medical / Nursing / professional registration"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            >
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <label class="flex items-start gap-3">
                            ...
                            <span>
                                ...
                                <span class="block text-sm text-gray-500">
                                    Enable this for doctors who should be available for consultant and doctor selections.
                                </span>
                            </span>
                        </label>
                        ...
                        <label class="flex items-start gap-3">
                            ...
                            <span>
                                ...
                                <span class="block text-sm text-gray-500">
                                    Only active employees should normally appear in operational ERP selections.
                                </span>
                            </span>
                        </label>
