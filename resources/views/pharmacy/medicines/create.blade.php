                            ...
                            <div>
                                ...
                                >
                                    @foreach ([0, 5, 12, 18, 28] as $gst)
                                        <option
                                            value="{{ $gst }}"
                                            @selected(old('gst_percent', 0) == $gst)
                                        >
                                            {{ $gst }}%
                                        </option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach ([
                                        ...
                                        <option
                                            value="{{ $pack }}"
                                            @selected(old('purchase_pack') === $pack)
                                        >
                                            {{ $pack }}
                                        </option>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updatePackPreview() {
                ...
                const unitName = unit.options[unit.selectedIndex]?.text || 'unit';
                const quantity = parseInt(unitsPerPack.value || '1', 10);

                preview.textContent =
                    '1 ' + packName +
                    ' = ' + quantity + ' ' +
                    unitName + (quantity === 1 ? '' : 's');
            }

            pack.addEventListener('change', updatePackPreview);
            unit.addEventListener('change', updatePackPreview);
            unitsPerPack.addEventListener('input', updatePackPreview);
