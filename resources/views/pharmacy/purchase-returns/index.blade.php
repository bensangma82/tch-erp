        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Supplier returns and pharmacy stock reversals
                </p>
            </div>
    ...
    <div class="min-h-screen bg-slate-50 py-6">
        ...
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <form
                    method="GET"
                    action="{{ route('pharmacy.purchase-returns.index') }}"
                ...
                >
                    ...
                    <div class="lg:col-span-5">
                        ...
                        <input
                            ...
                            placeholder="Return no, supplier, credit note..."
                    ...
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Latest supplier returns are shown first
                            </p>
                        ...
                        <div class="text-sm text-slate-500">
                            {{ $returns->total() }}
                            {{ Str::plural('record', $returns->total()) }}
                        </div>
                                ...
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="px-5 py-4">
                                        ...
                                        <div class="font-medium text-slate-800">
                                            {{ $return->supplier_credit_note_no ?: '—' }}
                                        </div>

                                        @if ($return->supplier_credit_note_date)

                                            <div class="mt-1 text-xs text-slate-500">
                                                {{ $return->supplier_credit_note_date->format('d M Y') }}
                                            </div>
                                    ...
                                    <td class="px-5 py-4">
                                        ...
                                        <span class="inline-flex rounded-full bg-amber-50 px-2.5 py-1 text-xs font-semibold text-amber-700">
                                            {{ ucwords(str_replace('_', ' ', $return->reason ?? '—')) }}
                                        </span>
                                    ...
                                    <td class="whitespace-nowrap px-5 py-4 text-right">
                                        ...
                                        <a
                                            href="{{ route('pharmacy.purchase-returns.show', $return) }}"
                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <div class="mt-2 text-sm text-slate-500">
                                            Supplier returns will appear here after medicines are returned against completed GRNs.
                                        </div>
